// ============================================
// PASO 4: Componer la vista final en App
// ============================================

// Combina PostList y PostDetail usando estado local para el ID seleccionado.
// Descomenta el App completo y borra el placeholder:
...
export default function App() {
  return (
    <div style={{ fontFamily: 'system-ui', padding: '2rem', background: '#0F172A', minHeight: '100vh' }}>
      <h1 style={{ color: '#FF4154' }}>TanStack Query — Ejercicio 02</h1>
      <p style={{ color: '#94A3B8' }}>Sigue los pasos en los archivos de src/ para completar el ejercicio.</p>
    </div>
  )
}
