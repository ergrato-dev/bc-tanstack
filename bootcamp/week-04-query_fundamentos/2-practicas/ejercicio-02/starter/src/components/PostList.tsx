// ============================================
// PASO 2: useQuery para listar posts
// ============================================

// useQuery necesita dos campos obligatorios:
//   - queryKey: identifica la entrada en el cache
//   - queryFn:  función que devuelve una Promise con los datos
//
// Descomenta el componente PostList completo:
...
export function PostList(_props: { onSelect: (id: number) => void; selectedId: number | null }) {
  return <p style={{ color: '#94A3B8' }}>PostList — descomenta el PASO 2</p>
}
